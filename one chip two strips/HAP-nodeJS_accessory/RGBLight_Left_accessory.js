...
var options = {
  ...
  port: 1883,
  clientId: 'RGBLight_2_Left_001'  // name to be introduced for MQTT broker
};
...
var RGBLight = {
  name: 'RGB Light Left',  // Has to be unique!
  gleamName: 'RGB Gleam',
  pincode: '111-69-111',  // you can change numbers keeping '-' symbols
  username: 'A1:D0:81:F4:BA:9A',  // MAC like address used by HomeKit to differentiate accessories. Has to be unique in your net
  manufacturer: 'Suren Khorenyan',  // (optional)
  model: 'RGBLight_WebConfig',  // (optional)
  serialNumber: 'RGBLight_2_Left_001',  // (optional)
